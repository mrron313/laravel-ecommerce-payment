...
define("SSLCZ_STORE_ID", env('SSLWPAYMENT_STORE_ID'));
define("SSLCZ_STORE_PASSWD", env('SSLWPAYMENT_STORE_PASSWORD'));
...
class SSLCommerz
{
    ...
    public function __construct()
    {
        ...
        $this->store_id = 'sslla5d521ea7705ba';
        $this->store_pass = 'sslla5d521ea7705ba@ssl';
    ...
    public function initiate($post_data, $get_pay_options = false)
    {
        if ($post_data != '' && is_array($post_data)) {
            ...
            \Log::info($post_data['store_id']);
            \Log::info($post_data['store_passwd']);
